...
const FALLBACK_PROJECTS = [
  ...
  },
  {
    ...
    description: 'A comprehensive restaurant management system with JWT auth, WebSocket KDS, inventory tracking, and invoice billing.',
    github: 'https://github.com/anuragsahu0/restaurant-management-system',
    demo: '#',
    techStack: ['Node.js', 'Express', 'React', 'PostgreSQL', 'Redis', 'WebSockets'],
    isFeatured: false,
    order: 2,
    metrics: [

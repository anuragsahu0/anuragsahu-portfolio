...
import { ROADMAP_ITEMS } from '@/data/skillsData';

/**
 * LearningRoadmap Component
 * Displays technologies currently being explored on Anurag's engineering roadmap.
 */
  ...
  return (
    <GlassCard className="p-6 space-y-4 border-white/10 bg-black/40">
      <div className="flex items-center justify-between border-b border-white/10 pb-3">
        ...
        <span className="font-mono text-[10px] text-dim">CONTINUOUS_GROWTH</span>
      </div>
          ...
          <div key={idx} className="p-3.5 rounded-xl bg-white/5 border border-white/5 space-y-2 flex flex-col justify-between hover:border-quantum-violet/40 transition-colors">
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                <span className="text-starlight font-bold text-xs flex items-center gap-1">
                  {item.topic}
                </span>
